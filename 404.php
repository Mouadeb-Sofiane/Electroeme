...
        <div class="oups">
            <h1> Oups !</h1>
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/404Electroeme_img.png" alt="oups" class="error-image">
        </div>
...
    body {
        background-image: url('<?php echo get_stylesheet_directory_uri(); ?>./img/boussole.jpg');
